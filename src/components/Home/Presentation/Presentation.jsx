    ...
    <div className="h-full flex flex-col items-center justify-start">
      ...
      <div className="flex flex-col xl:flex-row ">
        <div className="xl:p-20 xl:pt-0 pt-20 p-5 flex justify-center items-center ">
          <img src={shape} alt="Logo" className="rounded-lg object-cover" />
        </div>
        ...
        <div className="flex flex-col justify-start items-start xl:ml-16 xl:p-8 p-5 md:p-14">
          <p className="text-five md:text-2xl pb-10   ">
            Lorem ipsum in gravida pulvinar nostra elementum inceptos curae
            inceptos accumsan condimentum leo:
          </p>
