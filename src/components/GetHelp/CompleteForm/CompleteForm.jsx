...
const CompleteForm = ({}) => {
  return (
    <div className="flex flex-col justify-center items-center">
        <About/>
        <p className="w-[50rem] text-center pt-5 justify-center">A therapist will be available for your specific needs shortly, meanwhile you may proceed to payment.
            Here are the payment plans available:</p>
